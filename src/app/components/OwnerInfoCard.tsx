...
export function OwnerInfoCard() {
  return (
    ...
    >
      <div className="bg-gradient-to-br from-purple-500/40 via-pink-500/40 to-yellow-500/40 backdrop-blur-lg rounded-3xl p-8 border-4 border-white/60 shadow-2xl">
